...
st.markdown('<p class="rules-font">Created from love of learning math by <a href="https://www.linkedin.com/in/amirgiveon/">Amir Giveon</a> from <a href="https://www.neuron.vision">Neuron Vision</a>. </p>', unsafe_allow_html=True)
